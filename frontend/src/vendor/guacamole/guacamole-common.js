...
/* eslint-disable */
/*
 * guacamole-common-js 1.6.0 —— Apache Guacamole 瀏覽器端函式庫，原樣取自官方原始碼（見同目錄 SOURCE）。
 * 唯一的改動：把官方打包（common/license.js＋modules/*.js 依檔名串接）包成 ES module，
 * 最後加一行 export。不要直接改這個檔案；升版照 SOURCE 的步驟重新產生。
 */
/*
...
/* ---- modules/AudioContextFactory.js ---- */
/*
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
/* ---- modules/KeyEventInterpreter.js ---- */
/*
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
