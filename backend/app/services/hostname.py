...
DEFAULT_ORDER: list[str] = ["manual", "dns", "librenms", "opnsense", "pfsense", "fortigate", "paloalto", "mikrotik", "windows_dhcp", "scanner", "netbios", "mdns", "proxmox", "zabbix", "wazuh", "adguard", "ocs"]
